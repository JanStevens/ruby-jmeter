module RubyJmeter
  module Nodes
    module Plugins
      class ResponseTimesPercentiles < Nodes::Base
        ...
        def node
          ...
          <kg.apc.jmeter.vizualizers.CorrectedResultCollector guiclass="kg.apc.jmeter.vizualizers.ResponseTimesPercentilesGui" testclass="kg.apc.jmeter.vizualizers.CorrectedResultCollector" testname="" enabled="true">
