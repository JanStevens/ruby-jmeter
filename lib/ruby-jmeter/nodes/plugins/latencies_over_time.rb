module RubyJmeter
  module Nodes
    module Plugins
      # @TODO objProp
      class LatenciesOverTime < Nodes::Base
        ...
        def node
          ...
          <kg.apc.jmeter.vizualizers.CorrectedResultCollector guiclass="kg.apc.jmeter.vizualizers.LatenciesOverTimeGui" testclass="kg.apc.jmeter.vizualizers.CorrectedResultCollector" testname="" enabled="#{enabled(params)}">
